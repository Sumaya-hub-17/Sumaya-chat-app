...
const Onboarding = ({ darkMode }) => {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col items-center relative px-4 ${
    ...
    >
      ...
      <h1 className="mt-4 text-3xl sm:text-4xl font-bold text-center">
        Welcome To
      ...
      <p className="mt-2 text-sm sm:text-base text-center text-gray-400 md:text-gray-500">
